...
while True:
    ...
    if faceCurFrame:
        for encodeFace , faceLoc in zip(encodeCurFrame,faceCurFrame):
            ...
            #to get least value in matches list
        ...
        if counter!=0:
            ...
            if counter == 1:
                ...
                #update the data
                datetimeOject = datetime.strptime(studentInfo['last_attendance_time'],
                                                "%Y-%m-%d %H:%M:%S")
                secondElapsed = (datetime.now()-datetimeOject).total_seconds()
                if secondElapsed > 60:
